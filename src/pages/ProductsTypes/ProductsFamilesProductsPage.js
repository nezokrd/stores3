...
import FilterAddress from '../../Components/FilterAddress.js';
 ...
 const ProductsFamilesProductsPage = () => {
  
    const title="قائمة الاسر المنتجة"
    const [StoresTypes]=ViewStoresTypeHook(3);
    const [CategoriesType]=ViewHomeCategoriesTypeHook(3);
...
export default ProductsFamilesProductsPage