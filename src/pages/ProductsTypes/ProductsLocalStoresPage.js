...
import ViewDistrictsHook from '../../hook/view-districts-hook.js';
 ...
 const ProductsLocalStoresPage = () => {
  
    const title="قائمة المتاجر المحلية"
    const [StoresTypes]=ViewStoresTypeHook(2);
    const [CategoriesType]=ViewHomeCategoriesTypeHook(2);
...
export default ProductsLocalStoresPage